      ...
      <>
            ...
            <div className="row icon-boxes">
              <div className="col-md-6 col-lg-3 d-flex align-items-stretch mb-5 mb-lg-0" data-aos="zoom-in" data-aos-delay="200">
                <div className="icon-box">
                  <div className="icon"><i className="ri-stack-line"><Fa500Px /> </i></div>
              ...
              <div className="col-md-6 col-lg-3 d-flex align-items-stretch mb-5 mb-lg-0" data-aos="zoom-in" data-aos-delay="300">
                <div className="icon-box">
                  <div className="icon"><i className="ri-palette-line"><FaAccusoft /></i></div>
              ...
              <div className="col-md-6 col-lg-3 d-flex align-items-stretch mb-5 mb-lg-0" data-aos="zoom-in" data-aos-delay="400">
                <div className="icon-box">
                  <div className="icon"><i className="ri-command-line"><FaAffiliatetheme /></i></div>
              ...
              <div className="col-md-6 col-lg-3 d-flex align-items-stretch mb-5 mb-lg-0" data-aos="zoom-in" data-aos-delay="500">
                <div className="icon-box">
                  <div className="icon"><i className="ri-fingerprint-line"><FaAirbnb /></i></div>
          ...
          <div className="container" data-aos="fade-up">
            ...
            <div className="row content">
              <div className="col-lg-6">
                ...
                <ul>
                  <li><i className="ri-check-double-line"><FaCheckDouble /></i> Ullamco laboris nisi ut aliquip ex ea commodo consequat</li>
                  <li><i className="ri-check-double-line"><FaCheckDouble /></i> Duis aute irure dolor in reprehenderit in voluptate velit</li>
                  <li><i className="ri-check-double-line"><FaCheckDouble /></i> Ullamco laboris nisi ut aliquip ex ea commodo consequat</li>
                </ul>
              </div>
        ...
        <section id="portfolio" className="portfolio">
          <div className="container" data-aos="fade-up">
            ...
            <div className="row portfolio-container" data-aos="fade-up" data-aos-delay="300">
              {alltopics_Response && alltopics_Response?.records?.map((val, Tkey) => (
        ...
        <section id="contact" class="contact">
          <div class="container" data-aos="fade-up">
            ...
            <div>
              <iframe style={{ border: "0", width: "100%", height: "270px", }} src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d114289.64404899447!2d74.55087521201493!3d26.470186257389123!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x396be6540d33f475%3A0x72884a3dc10a061b!2siBirds%20Software%20Services%20Pvt.%20Ltd.!5e0!3m2!1sen!2sin!4v1692008065797!5m2!1sen!2sin" frameborder="0" allowfullscreen></iframe>
            </div>
            <div class="row mt-5">
              ...
              <div class="col-lg-4">
                <div class="info">
                  <div class="address">
                    ...
                    <h4>Location:</h4>
                    <p>Shreenath Mall In Ajmer 32****** <br />
                      Near About Bajrang Garh Chouraha.</p>
                  </div>
