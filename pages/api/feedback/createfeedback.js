...
export default async (req, res) => {
    if (req.method == "POST") {
        ...
        if (!name || !email) { return errorHandler(res, 400, "Please Enter All Field !") }
        ...
        if (nodemailer) {
            ...
            const mailmessage = {
                from: '"Prince parmar 👻"pp436643@gmail.com', // sender address
                to: email, // list of receivers
                subject: `${subject} ✔`, // Subject line
                text: `${message} ?`, // plain text body
                html: "<b>Prince parmar blog?</b>", // html body
            }
            await connectDB()
